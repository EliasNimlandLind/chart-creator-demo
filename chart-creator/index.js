import ChartGenerator from "./library/js/chartGenerator";
...
const datasets = [
  {
    ...
    data: [
      ...
      111, 111, 110, 85, 82, 111, 88, 215, 30, 530, 29, 30, 32, 30, 31, 29, 30,
      31, 29, 30, 32, 30, 29, 31, 30, 29, 30, 31, 29, 30, 32, 31, 30, 29, 30,
      31, 32, 30, 390, 31, 29, 30, 32, 30, 31, 29, 30, 31, 29, 30, 32, 306, 29,
      31, 30, 29, 30, 31, 29, 30, 32, 31, 30, 29, 310, 31, 32, 530, 30, 31, 259,
      30, 32, 30, 31, 29, 30, 31, 29, 30, 32, 30, 329, 431, 30, 29, 30, 31, 29,
      530, 32, 31, 30, 29, 30, 31, 32, 30, 30, 31, 29, 530, 32, 1, 31, 29, 30,
      31, 29, 30, 326, 1, 29, 31, 30, 29, 30, 530, 29, 530, 342, 31, 30, 29, 30,
      31, 32, 30, 301, 31, 29, 30, 32, 30, 31, 29, 30, 31, 29, 530, 32, 30, 239,
      31, 380, 29, 30, 31, 29, 30, 32, 31, 30, 29, 30, 31, 32, 30, 30, 31, 29,
      30, 32, 30, 31, 29, 30, 31, 29, 30, 32, 30, 269, 31, 530, 530, 30, 31, 29,
      30, 32, 31, 30, 29, 320, 31, 32, 30,
    ],
  },
  {
    label: "Dataset B",
    data: [
      ...
      32, 30, 30, 530, 29, 30, 32, 30, 31, 29, 30, 31, 29, 30, 32, 30, 29, 31,
      30, 29, 30, 31, 29, 30, 32, 31, 30, 29, 30, 31, 32, 30, 390, 31, 29, 30,
      32, 30, 31, 29, 30, 31, 29, 30, 32, 306, 29, 31, 30, 29, 30, 31, 29, 30,
      32, 31, 30, 29, 310, 31, 32, 530, 30, 31, 259, 30, 32, 30, 31, 29, 30, 31,
      29, 30, 32, 30, 329, 431, 30, 29, 30, 31, 29, 530, 32, 31, 30, 29, 30, 31,
      32, 30, 30, 31, 29, 530, 32, 1, 31, 29, 30, 31, 29, 30, 326, 1, 29, 31,
      30, 29, 30, 530, 29, 530, 342, 31, 30, 29, 30, 31, 32, 30, 301, 31, 29,
      30, 32, 30, 31, 29, 30, 31, 29, 530, 32, 30, 239, 31, 380, 29, 30, 31, 29,
      30, 32, 31, 30, 29, 30, 31, 32, 30, 30, 31, 29, 30, 32, 30, 31, 29, 30,
      31, 29, 30, 32, 30, 269, 31, 530, 530, 30, 31, 29, 30, 32, 31, 30, 29,
      320, 31, 32, 30,
    ],
  },
];
